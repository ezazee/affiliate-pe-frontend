...
__turbopack_context__.s([
    ...
    ()=>getAffiliateLinkByCode,
    "getCommissionsByAffiliatorId",
    ()=>getCommissionsByAffiliatorId,
    "getLinksByAffiliatorId",
    ()=>getLinksByAffiliatorId,
    "getOrdersByAffiliatorId",
    ()=>getOrdersByAffiliatorId,
    "getProductById",
    ()=>getProductById,
    "getProductBySlug",
...
const getAffiliateLinkByCode = (code)=>affiliateLinks.find((l)=>l.code === code && l.isActive);
const getOrdersByAffiliatorId = (affiliatorId)=>orders.filter((o)=>o.affiliatorId === affiliatorId);
const getCommissionsByAffiliatorId = (affiliatorId)=>commissions.filter((c)=>c.affiliatorId === affiliatorId);
const getLinksByAffiliatorId = (affiliatorId)=>affiliateLinks.filter((l)=>l.affiliatorId === affiliatorId);
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/affiliators/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminAffiliators() {
    ...
    const updateStatus = (userId, newStatus)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Affiliator ${newStatus}`);
    };
...
_s(AdminAffiliators, "C8CdhKCqEWB5J+uJVgDjG85QgPE=");
_c = AdminAffiliators;
var _c;
__turbopack_context__.k.register(_c, "AdminAffiliators");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_4abe806a._.js.map