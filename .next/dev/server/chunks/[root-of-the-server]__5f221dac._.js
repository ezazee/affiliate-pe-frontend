...
"[project]/src/app/api/affiliator/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!affiliatorId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'affiliatorId is required'
        }, {
            status: 400
        });
    }
    try {
        ...
        const userCommissions = (await db.collection('commissions').find({
            affiliatorId
        }).toArray()).map((commission)=>({
                ...commission,
                id: commission._id.toString()
            }));
        const userLinks = (await db.collection('affiliateLinks').find({
            affiliatorId
        }).toArray()).map((link)=>({
                ...link,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f221dac._.js.map