...
"[project]/src/app/api/admin/affiliators/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const db = client.db();
        const affiliators = await db.collection('users').find({
            role: 'affiliator'
        }).toArray();
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(formattedAffiliators);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4c491519._.js.map